...
function register({ init: init3, update: update3, view: view2, on_attribute_change: on_attribute_change2 }, name2) {
  if (!is_browser())
    return new Error(new NotABrowser());
  if (!name2.includes("-"))
  ...
  window.customElements.define(
    name2,
    makeComponent(init3, update3, view2, on_attribute_change2)
  );
  return new Ok(void 0);
}
function makeComponent(init3, update3, view2, on_attribute_change2) {
  return class LustreClientComponent extends HTMLElement {
    ...
    constructor() {
      super();
      on_attribute_change2[0]?.forEach((decoder2, name2) => {
